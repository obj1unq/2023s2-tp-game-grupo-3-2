...
object mapaNivel1 inherits Mapa(celdas = [ 
		...
		[e,_,_,n,_,_,_,_,_,_,_,_,c,_,_],
		[a,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
		[e,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
		[a,_,_,_,e,_,_,_,_,_,_,_,_,_,_],
		[a,_,_,_,_,_,_,_,_,_,e,_,_,_,_],
		[e,f,_,_,_,_,_,_,_,_,_,_,_,_,_],
		[a,_,_,r,_,_,_,_,_,_,_,_,_,_,_],
		[e,_,m,_,_,_,_,_,_,n,_,_,_,_,_],
		[a,a,a,e,a,a,e,e,a,a,a,e,a,e,a],
...
object mapaNivel2 inherits Mapa(celdas = [ 
		...
		[s,_,s,_,_,_,_,_,_,_,_,_,_,_,_],
		[s,_,_,_,_,_,_,_,_,_,_,s,_,_,_],
		[s,_,f,_,_,_,s,_,_,_,_,_,_,_,_],
		[s,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
		[s,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
		[s,_,_,s,_,_,_,_,_,_,_,_,_,_,_],
