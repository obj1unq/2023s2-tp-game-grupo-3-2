...
class ImagenFondo {
	...
	method image() = "imagen." + imagen + ".jpg"
...
object fondoGameOver inherits ImagenFondo(imagen = "gameOver") {

}

object fondoWinner inherits ImagenFondo(imagen = "winner") {

}

object inicioJuego inherits ImagenFondo(imagen = "inicioJuego") {
